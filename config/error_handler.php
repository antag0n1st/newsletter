...
$_error_buffer  = "<style type=\"text/css\"> .error-buffer{ width:600px; height:300px;position:fixed;z-index:10000000000; left:50%;top:50%;margin-left:-300px;margin-top:-150px;overflow-y: scroll; overflow-x: hidden;background-color: #252a2e; border:2px solid black; padding:10px;}</style>";
$_error_buffer .= '<div class="error-buffer">';
$_error_buffer .= '<div id="close-error" style="position:absolute;right:0; top:0; margin:5px; padding: 2px 5px 2px 5px;background-color:red; cursor:pointer;">X</div>';
