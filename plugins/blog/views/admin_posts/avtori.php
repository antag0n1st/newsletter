...
<?php } ?>
    ...
    <div id="choose_author" style="display: none; position: absolute; width: 300px; left: 50%;top: 30%; margin-left: -150px; background: white; border: 1px solid black; padding: 10px;">
        <h2>Измена на Автор</h2>
        <div>
