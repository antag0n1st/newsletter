<?php
    ...
    public static $db_fields = array(
        ...
        public $enabled = 1;
        public $permalink;
        public $thumbnail_attribute;
        public $click_count;
        /**
         * 'none','video','photo' 
         */
        public $thumbnail_tag = 'none';
    ...
    public static function find_top_posts($limit = 5){
        
        $query  = " SELECT * FROM " . static::$table_name." ";
        $query .= " WHERE release_date >= DATE_ADD(NOW(),INTERVAL -7 MONTH) ";
